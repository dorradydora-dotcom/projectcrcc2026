...
class Report3Controller extends GetxController {
  ...
  static const String _tableName = 'report_3';
  ...
  Future<void> generateAndSharePdf() async {
    ...
    try {
            ...
            pw.Directionality(
              ...
              child: pw.Column(children: [
                pw.Header(
                  level: 0,
                  child: pw.Center(
                    child: pw.Text(PdfHelper.prepareArabic('تقرير 3'),
      ...
      await Printing.sharePdf(bytes: await pdf.save(), filename: 'report_3.pdf');
    } catch (e) {
