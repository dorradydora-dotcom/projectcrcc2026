...
class Report1Controller extends GetxController {
  ...
  static const String _tableName = 'report_1';
  ...
  Future<void> generateAndSharePdf() async {
    ...
    try {
              ...
              child: pw.Column(
                children: [
                  pw.Header(
                    ...
                    child: pw.Center(
                      child: pw.Text(
                        PdfHelper.prepareArabic('تقرير 1'),
      ...
      await Printing.sharePdf(bytes: await pdf.save(), filename: 'report_1.pdf');
    } catch (e) {
