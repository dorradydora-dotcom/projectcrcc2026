...
class Report4Controller extends GetxController {
  ...
  static const String _tableName = 'report_4';
  ...
  Future<void> generateAndSharePdf() async {
    ...
    try {
            ...
            pw.Directionality(
              ...
              child: pw.Column(children: [
                pw.Header(
                  level: 0,
                  child: pw.Center(
                    child: pw.Text(PdfHelper.prepareArabic('تقرير 4'),
      ...
      await Printing.sharePdf(bytes: await pdf.save(), filename: 'report_4.pdf');
    } catch (e) {
